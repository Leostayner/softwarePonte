...
def matrixRestructure(matrix,graus):
   ...
   def comprimento(self, elemento):
        xa = float(self.matrizCordenadas[float(self.matrizIndices[elemento - 1][1]) + 1][1])
        yb = float(self.matrizCordenadas[float(self.matrizIndices[elemento - 1][1]) + 1][2])
        xb = float(self.matrizCordenadas[float(self.matrizIndices[elemento - 1][2]) + 1][1])
        yb = float(self.matrizCordenadas[float(self.matrizIndices[elemento - 1][2]) + 1][2])
